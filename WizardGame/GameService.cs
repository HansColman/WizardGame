...
namespace WizardGame
{
    public class GameService
    {
        ...
        public GameService()
        {
            scoreboards = new ScoreBoard.Scoreboard[7];
        }
        /// <summary>
        ...
        public void Play5Players(string player1Name, string player2Name, string player3Name, string player4Name, string player5Name)
        {
            ...
            scoreboards[5].PlayersName = player5Name;
        }
        /// <summary>
        ...
        public int SetResultPlayer2(int recieved, int requested)
        {
            ...
            scoreboards[2].Received= recieved;
        ...
        {
            scoreboards[6].Requested = requested;
            scoreboards[6].Received = recieced;
            return scoreboards[6].Score;
        }
    }
}
